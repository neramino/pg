...
def read_header(file_name, header_length):
    ...
    """
    with open(file_name, 'rb') as file:  # otevření souboru v binárním režimu
        return file.read(header_length)   # přečte požadovaný počet bytů
...
def is_png(file_name):
    ...
    #Funkce zkusí přečíst ze souboru hlavičku obrázku png, tu srovná s definovanou hlavičkou v proměnné png_header
...
if __name__ == '__main__':
    try:
        # načteme jméno souboru z argumentů příkazové řádky
